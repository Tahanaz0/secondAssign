...
function Footer() {
  return (
    ...
    <div className=' bg-[#F0F0F0]  '>
      <div className="flex flex-col sm:flex-col md:flex-row justify-between m-8 border-b-2 border-gray-400 ">
        <div>
        ...
        <div>
          <ul className="pt-16  flex flex-col justify-evenly gap-5">
            <li className="font-bold  text-xl sm:text-xl md:text-xl">Company</li>
            <li>About </li>
            <li>Features</li>
            <li>Works</li>
            <li>Careere</li>
        ...
        <div>
          <ul className="pt-16  flex flex-col justify-evenly gap-5">
            <li className="font-bold  text-xl sm:text-xl md:text-xl">Help</li>
        ...
        <div>
          <ul className="pt-16  flex flex-col justify-evenly gap-5">
            <li className="font-bold  text-xl sm:text-xl md:text-xl">F A Q</li>
            <li>Acount </li>
        ...
        <div>
          <ul className="pt-16   flex flex-col justify-evenly gap-5">
            <li className="font-bold  text-xl sm:text-xl md:text-xl">Resources</li>
            <li>Free eBooks </li>
